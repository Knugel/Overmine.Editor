...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Toggle On Event")]
    public class WaitForToggleOnEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Toggle On Event";

        public override System.Type Type => typeof(Thor.WaitForToggleOnEvent);
