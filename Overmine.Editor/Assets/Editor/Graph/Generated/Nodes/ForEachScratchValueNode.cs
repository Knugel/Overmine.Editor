...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("For Each Scratch Value")]
    public class ForEachScratchValueNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "For Each Scratch Value";

        public override System.Type Type => typeof(Thor.ForEachScratchValue);
