...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Opened Event")]
    public class WaitForOpenedEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Opened Event";

        public override System.Type Type => typeof(Thor.WaitForOpenedEvent);
