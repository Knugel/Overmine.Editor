...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Prompted Event")]
    public class WaitForPromptedEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Prompted Event";

        public override System.Type Type => typeof(Thor.WaitForPromptedEvent);

        [GraphProcessor.Input("Prompter Output")]
        public Thor.SharedEntity m_prompterOutput;

        [GraphProcessor.Input("Position Output")]
        public BehaviorDesigner.Runtime.SharedVector3 m_positionOutput;

        [GraphProcessor.ShowInInspector]
        public Thor.InteractableExt.PromptType m_promptType;
