...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Footstep Event")]
    public class WaitForFootstepEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Footstep Event";

        public override System.Type Type => typeof(Thor.WaitForFootstepEvent);
