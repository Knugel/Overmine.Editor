...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Unequipped Event")]
    public class WaitForUnequippedEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Unequipped Event";

        public override System.Type Type => typeof(Thor.WaitForUnequippedEvent);

        [GraphProcessor.Input("Unequipper Output")]
        public Thor.SharedEntity m_unequipperOutput;
