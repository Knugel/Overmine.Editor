...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Collides Exit Event")]
    public class WaitForCollidesExitEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Collides Exit Event";

        public override System.Type Type => typeof(Thor.WaitForCollidesExitEvent);
