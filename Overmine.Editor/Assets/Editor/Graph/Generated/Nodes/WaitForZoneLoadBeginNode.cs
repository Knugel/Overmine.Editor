...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Zone Load Begin")]
    public class WaitForZoneLoadBeginNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Zone Load Begin";

        public override System.Type Type => typeof(Thor.WaitForZoneLoadBegin);
