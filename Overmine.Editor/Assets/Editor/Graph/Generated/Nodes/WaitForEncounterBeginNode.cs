...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Encounter Begin")]
    public class WaitForEncounterBeginNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Encounter Begin";

        public override System.Type Type => typeof(Thor.WaitForEncounterBegin);
