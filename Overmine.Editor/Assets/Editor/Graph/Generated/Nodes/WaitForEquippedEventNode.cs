...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Equipped Event")]
    public class WaitForEquippedEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Equipped Event";

        public override System.Type Type => typeof(Thor.WaitForEquippedEvent);

        [GraphProcessor.Input("Equipper Output")]
        public Thor.SharedEntity m_equipperOutput;
