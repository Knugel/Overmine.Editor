...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Jumps Event")]
    public class WaitForJumpsEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Jumps Event";

        public override System.Type Type => typeof(Thor.WaitForJumpsEvent);
