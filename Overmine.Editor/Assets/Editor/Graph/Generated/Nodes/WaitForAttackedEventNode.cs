...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Attacked Event")]
    public class WaitForAttackedEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Attacked Event";

        public override System.Type Type => typeof(Thor.WaitForAttackedEvent);
        ...
        [GraphProcessor.Input("Hint Output")]
        public BehaviorDesigner.Runtime.SharedString m_hintOutput;
