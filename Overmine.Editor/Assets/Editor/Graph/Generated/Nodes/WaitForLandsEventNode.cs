...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Lands Event")]
    public class WaitForLandsEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Lands Event";

        public override System.Type Type => typeof(Thor.WaitForLandsEvent);

        [GraphProcessor.Input("Landed On")]
        public Thor.SharedEntity m_landedOn;
