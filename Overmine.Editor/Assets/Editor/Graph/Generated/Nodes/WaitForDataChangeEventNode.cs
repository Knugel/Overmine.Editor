...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Data Change Event")]
    public class WaitForDataChangeEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Data Change Event";

        public override System.Type Type => typeof(Thor.WaitForDataChangeEvent);
