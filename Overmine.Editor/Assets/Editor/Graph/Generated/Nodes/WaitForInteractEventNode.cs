...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Interact Event")]
    public class WaitForInteractEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Interact Event";

        public override System.Type Type => typeof(Thor.WaitForInteractEvent);

        [GraphProcessor.ShowInInspector]
        public Thor.InteractableExt.InteractionState m_state;

        [GraphProcessor.Input("Interactor Output")]
        public Thor.SharedEntity m_interactorOutput;
