...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Collides Stay Event")]
    public class WaitForCollidesStayEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Collides Stay Event";

        public override System.Type Type => typeof(Thor.WaitForCollidesStayEvent);
