...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Gains Frenzy Event")]
    public class WaitForGainsFrenzyEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Gains Frenzy Event";

        public override System.Type Type => typeof(Thor.WaitForGainsFrenzyEvent);

        [GraphProcessor.Input("Amount Output")]
        public BehaviorDesigner.Runtime.SharedFloat m_amountOutput;
