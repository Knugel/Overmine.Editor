...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Timer Event")]
    public class WaitForTimerEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Timer Event";

        public override System.Type Type => typeof(Thor.WaitForTimerEvent);
