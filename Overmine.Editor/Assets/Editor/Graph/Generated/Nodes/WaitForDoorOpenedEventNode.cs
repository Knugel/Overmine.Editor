...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Door Opened Event")]
    public class WaitForDoorOpenedEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Door Opened Event";

        public override System.Type Type => typeof(Thor.WaitForDoorOpenedEvent);
