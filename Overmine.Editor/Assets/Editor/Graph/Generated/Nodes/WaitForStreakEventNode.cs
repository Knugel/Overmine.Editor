...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Streak Event")]
    public class WaitForStreakEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Streak Event";

        public override System.Type Type => typeof(Thor.WaitForStreakEvent);

        [GraphProcessor.Input("Streaker Output")]
        public Thor.SharedEntity m_streakerOutput;
