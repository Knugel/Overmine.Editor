...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Loses Padding Event")]
    public class WaitForLosesPaddingEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Loses Padding Event";

        public override System.Type Type => typeof(Thor.WaitForLosesPaddingEvent);
