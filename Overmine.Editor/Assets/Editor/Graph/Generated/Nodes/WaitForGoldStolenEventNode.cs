...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Gold Stolen Event")]
    public class WaitForGoldStolenEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Gold Stolen Event";

        public override System.Type Type => typeof(Thor.WaitForGoldStolenEvent);
