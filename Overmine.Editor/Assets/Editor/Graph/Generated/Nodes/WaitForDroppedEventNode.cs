...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Dropped Event")]
    public class WaitForDroppedEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Dropped Event";

        public override System.Type Type => typeof(Thor.WaitForDroppedEvent);

        [GraphProcessor.Input("Dropper Output")]
        public Thor.SharedEntity m_dropperOutput;
