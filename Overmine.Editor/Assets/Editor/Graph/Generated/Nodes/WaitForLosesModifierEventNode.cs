...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Loses Modifier Event")]
    public class WaitForLosesModifierEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Loses Modifier Event";

        public override System.Type Type => typeof(Thor.WaitForLosesModifierEvent);
