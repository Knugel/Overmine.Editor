...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Toggle Event")]
    public class WaitForToggleEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Toggle Event";

        public override System.Type Type => typeof(Thor.WaitForToggleEvent);
