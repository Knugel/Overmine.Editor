...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Chance")]
    public class ChanceNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Chance";

        public override System.Type Type => typeof(Thor.Chance);
