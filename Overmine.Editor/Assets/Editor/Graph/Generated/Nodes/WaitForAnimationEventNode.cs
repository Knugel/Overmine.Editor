...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Animation Event")]
    public class WaitForAnimationEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Animation Event";

        public override System.Type Type => typeof(Thor.WaitForAnimationEvent);
