...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Dies Event")]
    public class WaitForDiesEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Dies Event";

        public override System.Type Type => typeof(Thor.WaitForDiesEvent);
