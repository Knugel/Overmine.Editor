...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Despawns Event")]
    public class WaitForDespawnsEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Despawns Event";

        public override System.Type Type => typeof(Thor.WaitForDespawnsEvent);
