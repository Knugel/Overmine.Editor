...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Poisoned Event")]
    public class WaitForPoisonedEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Poisoned Event";

        public override System.Type Type => typeof(Thor.WaitForPoisonedEvent);
