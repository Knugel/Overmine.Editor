...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Limit Reached Event")]
    public class WaitForLimitReachedEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Limit Reached Event";

        public override System.Type Type => typeof(Thor.WaitForLimitReachedEvent);
