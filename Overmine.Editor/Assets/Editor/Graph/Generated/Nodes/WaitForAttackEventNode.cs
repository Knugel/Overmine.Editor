...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Attack Event")]
    public class WaitForAttackEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Attack Event";

        public override System.Type Type => typeof(Thor.WaitForAttackEvent);

        [GraphProcessor.Input("Attackee Output")]
        public Thor.SharedEntity m_attackeeOutput;
