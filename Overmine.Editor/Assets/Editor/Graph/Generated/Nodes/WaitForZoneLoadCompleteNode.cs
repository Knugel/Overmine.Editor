...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Zone Load Complete")]
    public class WaitForZoneLoadCompleteNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Zone Load Complete";

        public override System.Type Type => typeof(Thor.WaitForZoneLoadComplete);
