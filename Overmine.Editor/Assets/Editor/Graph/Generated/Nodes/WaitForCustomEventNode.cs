...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Custom Event")]
    public class WaitForCustomEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Custom Event";

        public override System.Type Type => typeof(Thor.WaitForCustomEvent);
