...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Try Loses Resource Event")]
    public class WaitForTryLosesResourceEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Try Loses Resource Event";

        public override System.Type Type => typeof(Thor.WaitForTryLosesResourceEvent);
