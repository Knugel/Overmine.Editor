...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Used Event")]
    public class WaitForUsedEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Used Event";

        public override System.Type Type => typeof(Thor.WaitForUsedEvent);

        [GraphProcessor.Input("User Event")]
        public Thor.SharedEntity m_userEvent;
