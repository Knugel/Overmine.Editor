...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Charge Event")]
    public class WaitForChargeEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Charge Event";

        public override System.Type Type => typeof(Thor.WaitForChargeEvent);

        [GraphProcessor.Input("Charge Level Output")]
        public BehaviorDesigner.Runtime.SharedFloat m_chargeLevelOutput;
