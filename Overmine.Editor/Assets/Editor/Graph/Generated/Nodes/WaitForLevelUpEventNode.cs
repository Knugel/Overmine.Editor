...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Level Up Event")]
    public class WaitForLevelUpEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Level Up Event";

        public override System.Type Type => typeof(Thor.WaitForLevelUpEvent);

        [GraphProcessor.Input("Level Output")]
        public BehaviorDesigner.Runtime.SharedInt m_levelOutput;
