...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Uses Ability Event")]
    public class WaitForUsesAbilityEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Uses Ability Event";

        public override System.Type Type => typeof(Thor.WaitForUsesAbilityEvent);
