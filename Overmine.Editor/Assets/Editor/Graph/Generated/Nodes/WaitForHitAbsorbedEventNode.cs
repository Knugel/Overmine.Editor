...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Hit Absorbed Event")]
    public class WaitForHitAbsorbedEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Hit Absorbed Event";

        public override System.Type Type => typeof(Thor.WaitForHitAbsorbedEvent);
