...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Resource Change Event")]
    public class WaitForResourceChangeEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Resource Change Event";

        public override System.Type Type => typeof(Thor.WaitForResourceChangeEvent);

        [GraphProcessor.Input("Resource")]
        public Thor.ResourceData m_resource;

        [GraphProcessor.Input("Delta Output")]
        public BehaviorDesigner.Runtime.SharedInt m_deltaOutput;

        [GraphProcessor.Input("Total Output")]
        public BehaviorDesigner.Runtime.SharedInt m_totalOutput;
