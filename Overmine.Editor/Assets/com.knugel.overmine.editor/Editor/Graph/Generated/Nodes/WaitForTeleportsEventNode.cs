...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Teleports Event")]
    public class WaitForTeleportsEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Teleports Event";

        public override System.Type Type => typeof(Thor.WaitForTeleportsEvent);
