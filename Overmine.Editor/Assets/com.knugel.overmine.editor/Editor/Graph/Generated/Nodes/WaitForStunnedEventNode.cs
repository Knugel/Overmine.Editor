...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Stunned Event")]
    public class WaitForStunnedEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Stunned Event";

        public override System.Type Type => typeof(Thor.WaitForStunnedEvent);
