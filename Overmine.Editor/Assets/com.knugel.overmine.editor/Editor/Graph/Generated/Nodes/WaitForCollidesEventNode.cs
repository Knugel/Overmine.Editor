...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Collides Event")]
    public class WaitForCollidesEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Collides Event";

        public override System.Type Type => typeof(Thor.WaitForCollidesEvent);
        ...
        [GraphProcessor.Input("Normal Output")]
        public BehaviorDesigner.Runtime.SharedVector3 m_normalOutput;

        [GraphProcessor.Input("Reflect Output")]
        public BehaviorDesigner.Runtime.SharedVector3 m_reflectOutput;
