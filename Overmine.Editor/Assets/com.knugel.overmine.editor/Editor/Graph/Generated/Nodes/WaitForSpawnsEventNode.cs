...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Spawns Event")]
    public class WaitForSpawnsEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Spawns Event";

        public override System.Type Type => typeof(Thor.WaitForSpawnsEvent);
