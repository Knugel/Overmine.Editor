...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Losese Mana Event")]
    public class WaitForLoseseManaEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Losese Mana Event";

        public override System.Type Type => typeof(Thor.WaitForLoseseManaEvent);
