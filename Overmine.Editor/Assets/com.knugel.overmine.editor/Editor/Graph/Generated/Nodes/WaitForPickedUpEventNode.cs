...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Picked Up Event")]
    public class WaitForPickedUpEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Picked Up Event";

        public override System.Type Type => typeof(Thor.WaitForPickedUpEvent);

        [GraphProcessor.Input("Picker Output")]
        public Thor.SharedEntity m_pickerOutput;

        [GraphProcessor.Input("Slot Output")]
        public BehaviorDesigner.Runtime.SharedString m_slotOutput;
