...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Wait For Loses Status Effect Event")]
    public class WaitForLosesStatusEffectEventNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Wait For Loses Status Effect Event";

        public override System.Type Type => typeof(Thor.WaitForLosesStatusEffectEvent);
