...
{
    [System.Serializable, GraphProcessor.NodeMenuItem("Compare Scratch Value")]
    public class CompareScratchValueNode : Editor.Graph.Nodes.AbstractTaskNode
    {
        public override string name => "Compare Scratch Value";

        public override System.Type Type => typeof(Thor.CompareScratchValue);
